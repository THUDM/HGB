...
def gen_data(embed,edge_list):
    return Data(x=th.tensor(embed, dtype=th.float32),
...
def main(args):
    ...
    train(model,data,train_mask,val_mask,test_mask,labels,)
    test(model,data,test_mask,labels)
