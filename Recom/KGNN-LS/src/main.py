...
#                     default=16, help='the number of neighbors to be sampled')
...
# parser.add_argument('--ls_weight', type=float, default=1.0,
...
#                     default='restaurant', help='which dataset to use')
# parser.add_argument('--n_epochs', type=int, default=10,
#                     help='the number of epochs')
# parser.add_argument('--neighbor_sample_size', type=int,
#                     default=4, help='the number of neighbors to be sampled')
